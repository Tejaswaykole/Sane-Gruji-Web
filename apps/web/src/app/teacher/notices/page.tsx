...
export default function TeacherNoticesPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-slate-900">Staff Notice Board</h1>
        <p className="text-slate-500">View official school notices and announcements.</p>
      </div>
      ...
      <div className="grid gap-6">
        {loading ? (
          ...
          <div key={notice.id} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
